package pt.isel.ps1314v.g11.allp.giraph.io;
...
import pt.isel.ps1314v.g11.allp.ALLPVertexValue;
...
public class ALLPAdjacencyListWithValuesInputFormat extends TextVertexInputFormat<LongWritable, ALLPVertexValue,NullWritable>{
	...
	public class HeatKernelVertexReader extends TextVertexReaderFromEachLineProcessedHandlingExceptions<Text,IOException>{
		...
		@Override
		protected ALLPVertexValue getValue(Text line) throws IOException,
				IOException {
			long id = Long.parseLong(line.toString().split(" ")[1]);
			return new ALLPVertexValue(id,id);
		}
