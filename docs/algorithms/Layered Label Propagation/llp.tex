...
\section*{\textit{Layered Label Propagation}}
  ...
  Neste contexto as \textit{labels} serão iteradas de forma a que seja dada uma maior importância à que tem o vértice com menor ordem lexicográfica.
  ...
  O mesmo se faz para os outros vértices.
