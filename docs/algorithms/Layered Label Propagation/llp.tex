...
$label_i$. Cada vértice tem: $v_i$ e $label_i$.
...
vértices adjacentes informação acerca do vértice atual.
...
que recebeu. Para todas as mensagem, calcular $v_i$ e enviar o valor atualizado 
para todos os vértices que lhe enviaram a mensagem. No cálculo do $v_i$ há que 
...
É possível ainda mudar o representante no passo 4 para que este faça parte da 
comunidade de modo a que a troca de mensagens pela rede seja diminuída, caso 
sejam utilizados os particionamentos adequados.